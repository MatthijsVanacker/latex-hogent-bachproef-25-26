...
\newline \newline
Het uiteindelijke resultaat van dit onderzoek toont aan dat het mogelijk is om een fysieke spelersscore gebruikmakend van machine learning-technieken. De gecreëerde modellen hebben echter slechts beperkte voorspellingskracht. De oorzaak hiervoor ligt hoogstwaarschijnlijk aan het feit dat een voetbaluitslag niet louter beslist wordt door de fysieke prestaties van spelers op het veld maar ook aan veel andere factoren, zoals technische statistieken, tactische beslissingen en zelfs weersomstandigheden.
\newline \newline
